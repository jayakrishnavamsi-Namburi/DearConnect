  ...
  return (
    <ThemeProvider theme={theme}>
      <Grid container component="main" className="zoom-auth-root">
            ...
            <Grid container justifyContent="center">
              <Grid item>
                <Button
                  size="small"
                  onClick={() => {
                    const nextMode = formState === 0 ? 'register' : 'login';
        ...
        {/* Right side image/video/branding - Optional */}
        <Grid item sm={5} md={6} className="zoom-auth-image-side" />
      </Grid>
      <Snackbar open={open} autoHideDuration={4000} message={message} />
    </ThemeProvider>
  );
